...
pub struct Board {
    ...
    tile_c: Position,   // Set to 1 iff that square of the board is occupied by current turn player.
    tile_o: Position, // Set to 1 iff that square of the board is occupied by opposite turn player.
